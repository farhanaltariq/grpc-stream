...
const (
	MapService_Map_FullMethodName = "/protomessagergateway.MapService/Map"
)
...
func (c *mapServiceClient) Map(ctx context.Context, in *MapRequest, opts ...grpc.CallOption) (*MapResponse, error) {
	...
	out := new(MapResponse)
	err := c.cc.Invoke(ctx, MapService_Map_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MapService_Map_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MapService_Map_FullMethodName,
	}
...
var MapService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protomessagergateway.MapService",
	...
	Metadata: "source/messagergateway/messager.proto",
}
