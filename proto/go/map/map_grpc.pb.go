...
const (
	MapService_Hello_FullMethodName = "/map.MapService/Hello"
)
...
func (c *mapServiceClient) Hello(ctx context.Context, in *A, opts ...grpc.CallOption) (*B, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(B)
	err := c.cc.Invoke(ctx, MapService_Hello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMapServiceServer) Hello(context.Context, *A) (*B, error) {
...
func _MapService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MapService_Hello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MapServiceServer).Hello(ctx, req.(*A))
	}
